...
class ViewedPatient extends Component {
    render() {
        return (
                            ...
                            <View style={styles.appointmentDetailedWrapper}>
                                ...
                                <View style={styles.middleWrapper}>
                                    <TouchableOpacity
                                        ...
                                        activeOpacity={1}
                                        onPress={() => console.log("Call Patient")}>
                                        <Image
                                    ...
                                    <TouchableOpacity
                                        style={styles.profileImgWrapper}
                                        activeOpacity={1}
                                        onPress={() => console.log("Chat with Patient")}>
                                        <Image
                                    ...
                                    <TouchableOpacity
                                        style={styles.profileImgWrapper}
                                        activeOpacity={1}
                                        onPress={() => console.log("Vfixeideo Call Patient")}>
                                        <Image
